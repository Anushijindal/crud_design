...
// $find_id="SELECT user_id FROM employee_users WHERE user_email='$session_email'";
...
if (isset($_POST['submit'])) {
  ...
  if (empty($errors)) {
    $sql = "INSERT INTO `employee_users` (user_firstname,user_city_id,user_state_id,gender,user_lastname,user_email,user_phone,user_password,user_street_address,user_country_id,user_role_id,Active_status)
