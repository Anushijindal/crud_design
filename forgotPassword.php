...
if (isset($_POST['reset'])) {
  ...
  $sql = "SELECT user_email,user_firstname,user_id FROM `employee_users` WHERE user_email='$email'";
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    // echo $user_email;
    // echo "$token";
    $update_token = "UPDATE `employee_users` SET token = '$token' WHERE user_email='$user_email' AND user_firstname='$user_firstname'";
